  ...
  async initializeDropdowns() {
    try {
      ...
      if (existingInsurers.length === 0) {
        ...
        await referenceDataRepository.seedInsurers([
      ...
      if (existingRoofTypes.length === 0) {
        ...
        await referenceDataRepository.seedRoofTypes([
      ...
      if (existingWallTypes.length === 0) {
        ...
        await referenceDataRepository.seedExternalWallTypes([
      ...
      if (existingFloorTypes.length === 0) {
        ...
        await referenceDataRepository.seedFloorTypes([
      ...
      if (existingBuildingTypes.length === 0) {
        ...
        await referenceDataRepository.seedBuildingTypes([
